...
/*
    public Node Node_Ball(Vector3 position)
    {
        //position.y = 5.0f;
...
*/
    public Node Node_Throw()
    {
        ...
        return new DecoratorCatch(
            () => this.Character.BodyAnimation("Throw", false),
            new Sequence(
                this.Node_BodyAnimation("Throw", true),
                new LeafWait(2500),
                this.Node_BodyAnimation("Throw", false)));
    }

    public Node Node_Catch()
    {
        return new DecoratorCatch(
            () => this.Character.BodyAnimation("Catch", false),
            new Sequence(
                this.Node_BodyAnimation("Catch", true),
                new LeafWait(2500),
                this.Node_BodyAnimation("Catch", false)));
    }

    public Node say(String str, Text T)
    {
        return new LeafInvoke(
            () => this.Character.Say(str, T));
    }
